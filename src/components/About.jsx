    ...
    <div className='flex flex-col w-full lg:justify-center lg:flex-row md:mb-5'>
      <div id='about' className='w-full p-5'>
        ...
        <div className='border-l-4 border-stone-800'>
          <h2 className='font-bold text-5xl ml-3 md:text-6xl md:font-bold'>Sobre<br />Estúdio Car Detalhamento</h2>
        </div>
      ...
      <div className='flex flex-col justify-center md:w-full'>
        ...
        <div className='flex flex-col md:flex-row p-5 gap-3 w-full justify-center items-center'>
          ...
          <div className='flex justify-around items-center w-full py-3 bg-stone-800'>
            <div>
              <h2 className='text-4xl md:text-5xl font-bold text-stone-200'>9+</h2>
            </div>
            <div>
              <p className='text-xl text-right text-stone-200'>Anos de<br />experiência</p>
            </div>
          </div>

          <div className='flex justify-around items-center w-full py-3 bg-stone-800'>
            <div>
              <h2 className='text-4xl md:text-5xl font-bold text-stone-200'>1K+</h2>
            </div>
            <div>
              <p className='text-xl text-right text-stone-200'>Carros<br />Detalhados</p>
            </div>
          </div>        
