        ...
        <div>
            ...
            <div className='w-full flex justify-start items-center'>
                <div className='bg-stone-800 rounded-full w-16 h-16 flex items-center justify-center p-5'>
                    <h2 className='text-stone-200 text-2xl font-bold'>{reviews[currentIndex].initialName}</h2>
                </div>

                <div className='ml-5'>
                    <h2 className='text-2xl font-medium'>{reviews[currentIndex].name}</h2>
                </div>
            </div>
            ...
            <div className='w-full grid grid-cols-2'>
                ...
                <div className='flex flex-row justify-end items-center gap-3'>
                    <div onClick={prevIndex} className='rounded-full h-10 w-10 bg-stone-300 text-white flex justify-center items-center'>
                        <FaLongArrowAltLeft size={30} />
                    </div>
                    <div onClick={nextIndex} className='rounded-full h-10 w-10 bg-stone-300 text-white flex justify-center items-center'>
